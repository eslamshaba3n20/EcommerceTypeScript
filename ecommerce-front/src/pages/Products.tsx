...
const Products = () => {
    ...
    const productFullInfo = records.map((record) => { return { ...record, quantity: cartItems[record.id] || 0 } });
    ...
    return (
        <Container>
            <Headding><span className="text-uppercase">{params.prefix}</span> Products</Headding>
